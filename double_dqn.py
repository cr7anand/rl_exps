...
# -*- coding: utf-8 -*-
"""
Created on Sun Feb  4 00:49:31 2018
...
def clone_model(model):
	torch.save(model,'Double_Q_network_model.pt')
	target_model = torch.load('Double_Q_network_model.pt')
	return target_model

# init target network (copy of agent Q-network)	
...
optimizer = optim.RMSprop(model.parameters(), eps = 0.01, lr=0.00025, momentum=0.95,centered=True) 
